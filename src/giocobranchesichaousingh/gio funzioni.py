...
PERCORSO_GRIGLIA = [
    ...
    (6, 13), (6, 12), (6, 11), (6,10), (6, 9), (6, 8), (6, 7), (6, 6), (6, 5),
...
def disegna_pannello(schermo, stato, immagini, font_grande, font_medio, font_piccolo):
    ...
    schermo.blit(font_grande.render(f"♥ {stato['vite']}", True, ROSSO),            (X+10, 79))
    schermo.blit(font_grande.render(f"Ondata {stato['ondata']}/10", True, BIANCO), (X+10, 114))
    schermo.blit(font_grande.render(f"Punti: {calcola_punteggio(stato)}", True, (255,165,0)), (X+10, 149))
    schermo.blit(font_piccolo.render("nemici+ondate+vite", True, (160,160,160)),    (X+10, 184))
